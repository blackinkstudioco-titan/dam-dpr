            ...
            <form id="uploadForm" action="{{ route('data-foto.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="konseptor" class="block text-sm font-medium text-gray-700 mb-2">Konseptor</label>
                                <input type="text" id="konseptor" name="konseptor"
                                       value="{{ old('konseptor') }}" maxlength="32"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                            </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" id="judul_en" name="judul_en"
                                   value="{{ old('judul_en') }}" maxlength="60"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="deskrp_en" name="deskrp_en" rows="4"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">{{ old('deskrp_en') }}</textarea>
                        </div>
                    </div>
                </div>
