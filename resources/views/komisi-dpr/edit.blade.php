    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Alat Kelengkapan DPR (AKD)') }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('komisi-dpr.update', $komisiDpr->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   name="nama_komisi" 
                                   id="nama_komisi" 
                                   value="{{ old('nama_komisi', $komisiDpr->nama_komisi) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="bidang" 
                                      ...
                                      placeholder="Masukkan bidang komisi (contoh: Pertahanan, Keamanan, Luar Negeri)">{{ old('bidang', $komisiDpr->bidang) }}</textarea>
                            @error('bidang')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
